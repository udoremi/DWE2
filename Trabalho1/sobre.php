...
?>
    <main class="container mt-4">
        <div class="alert alert-info text-dark border border-info p-4 rounded">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <img src="https://cdn-icons-png.flaticon.com/512/15/15659.png" class="img-fluid" alt="Imagem de exemplo" width="350" height="200">
                </div> 
            </div>
        </div>
    </main>
