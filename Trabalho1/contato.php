...
?>
    <main class="container mt-4">
        <div class="alert alert-warning text-dark border border-warning p-4 rounded">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <img src="https://cdn-icons-png.flaticon.com/512/9194/9194840.png" class="img-fluid" alt="Imagem de exemplo" width="350" height="200">
                </div> 
            </div>
        </div>
    </main>
